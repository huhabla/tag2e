...
#       
    ...
    def test2(self):
        ...
        MetropolisCalibrator(model, parameter, 20000, 100, 0.1, 0.0001, "result", "measure")
...
# 2: left = 50  center = 50 right = 101
        ...
        resp.SetName("Responses")
        resp.SetDoubleAttribute("min", 0)
        resp.SetDoubleAttribute("max", 25)
    ...
    def test1(self):
        ...
        MetropolisCalibrator(model, parameter, 50000, 100, 0.1, 0.01, "result", "measure")
...
# 2: left = 50  center = 50 right = 101
    ...
    def test1(self):
        ...
        MetropolisCalibrator(model, parameter, 100000, 5, 2, 0.01, "result", "measure")


def MetropolisCalibrator(model, parameter, maxiter, maxFactor, sd, errorBreak, modelArray, measureArray):
    ...
    for i in range(maxiter):
        ...
        parameter.ModifyParameterRandomly(sd)
        model.Modified()
        model.Update()
...
if __name__ == '__main__':
    suite1 = unittest.TestLoader().loadTestsFromTestCase(vtkTAG2EAbstractModelCalibratorTestsHuge)
